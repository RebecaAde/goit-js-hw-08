...
feedbackForm.addEventListener("input", (0, _throttleDefault.default)(onInput, 500));
feedbackForm.addEventListener("submit", (0, _throttleDefault.default)(onFormSubmit, 500));
...
function onFormSubmit(e) {
    ...
    if (email.value === "" || message.value === "") alert("Please fill in the field");
}

},{"lodash/throttle":"lAb0D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lAb0D":[function(require,module,exports) {
